...
<title>Buat Surat Izin Sekolah Secepat Kilat - Generator</title>
  ...
  <link rel="icon" type="image/png" href="img/icon.png">
      <meta name="description" content="Sekarang Buat Surat Izin Sekolah Kamu disini dijamin Cepat dan Mudah by www.ahmadansori.xyz">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="contact.php">Kontak</a></li>
          <li><a href="https://paypal.me/aantech">Donasi</a></li>
      </ul>
    </div>
  </div>
</nav>
...
<p>Belum Punya Akun? <a href='registration.php'>Daftar Disini! Wajib</a></p>
</div>
<?php } ?>
